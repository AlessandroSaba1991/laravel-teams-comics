...
<section class="single_comic">
    ...
    <div class="container sm_ py-5">
        <div class="card_comic">
            <div class="img_comic">
                <img src="{{$chracter['thumb']}}" alt="{{$chracter['series']}}" />
        ...
        <div class="row g-0">
            <div class="col-8">
                <div class="text_comic">
                    <h2 class="text-uppercase mb-3 mt-4">{{$character['title']}}</h2>
                    <div class="row g-0">
                        <div class="col-9">
                            <div class="price">
                                <p><span>U.S. Price: </span>{{$character['price']}}</p>
                ...
                <div class="talent pb-5 mb-5 pe-3">
                    ...
                    <div class="detail">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <p>
                                    @php $artist = implode('<span class="text_dark">,</span> ',$character['artists'])
                                    @endphp
                                    <span>{!!$artist!!}</span>
                                </p>
                            </div>
                    ...
                    <div class="detail">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <p>
                                    @php $writer = implode('<span class="text_dark">,</span> ',$character['writers'])
                                    @endphp
                                    <span>{!!$writer!!}</span>
                                </p>
                            </div>
                ...
                <div class="specs">
                    ...
                    <div class="detail">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <p>
                                    <span class="text-uppercase">{{$character['series']}}</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="detail">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <p>
                                    {{date_format(date_create_from_format("Y-m-d",$character['sale_date']),"M d Y")}}
                                </p>
                            </div>
                        </div>
                    </div>
